...
const config = {
  generator: {
    ...
    output: {
      value: 'C:\\Users\\hp\\Desktop\\FULL_STACK\\nextks-template\\src\\app\\generated\\prisma',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
    ...
    previewFeatures: [],
    sourceFilePath: 'C:\\Users\\hp\\Desktop\\FULL_STACK\\nextks-template\\prisma\\schema.prisma',
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineDatasources: {
    db: {
      url: {
        ...
        value: 'postgresql://postgres:tarek2005@localhost:5433/nextjs-template',
      },
    },
  },
  inlineSchema:
